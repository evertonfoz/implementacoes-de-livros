...
namespace Capitulo06.Views.Atendimentos
{
	...
	public partial class FotosListagemView : ContentPage
	{
        ...
        protected async override void OnAppearing()
        {
            ...
            MessagingCenter.Subscribe<FotoListContainerControl>(this, "Remover", async (container) =>  { await RemoverContainer(container); });
        }

        private async Task ReposicionamentoDaImagemNoContainer(FotoListContainerControl container)
        {
