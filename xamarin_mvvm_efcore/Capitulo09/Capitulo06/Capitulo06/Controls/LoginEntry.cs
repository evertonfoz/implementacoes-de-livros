...
namespace Capitulo06.Controls
{
    ...
    {
        public static readonly BindableProperty BorderColorOnFocusProperty = BindableProperty.Create(
                nameof(BorderColorOnFocus),
                typeof(Color),
                typeof(LoginEntry),
                Color.Red);

        public static readonly BindableProperty BorderColorLostFocusProperty = BindableProperty.Create(
                nameof(BorderColorLostFocus),
                typeof(Color),
                typeof(LoginEntry),
                Color.Black);
