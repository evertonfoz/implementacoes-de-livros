...
namespace Capitulo06.Views.Atendimentos
{
	...
	public partial class FotosCRUDView : ContentPage
	{
        ...
        private async Task<bool> TirarFoto(AtendimentoFoto foto)
        {
        ...
        private async Task<bool> SelecionarFotoDoAlbum(AtendimentoFoto foto)
        {
            await CrossMedia.Current.Initialize();
        ...
        protected override void OnAppearing()
        {
            ...
            MessagingCenter.Subscribe<AtendimentoFoto>(this, "Camera", async (foto) => { await TirarFoto(foto); });
            MessagingCenter.Subscribe<AtendimentoFoto>(this, "Album", async (foto) => { await SelecionarFotoDoAlbum(foto); });
