...
namespace Modulo1.Pages.Pedidos
{
    public partial class PedidosNewPage : ContentPage
    {
        ...
        private async void BtnRegistrarPedidoClicked(object sender, EventArgs e)
        {
            ...
            {
                DisplayAlert("Sem itens", "Informe ao menos um item para o pedido", "Ok");
            }
            else
            {
                PreparePedidoToPersist();
                ClearControls();
                DisplayAlert("Pedido inserido", "Pedido foi registrado com sucesso", "Ok");
            }
        }
        ...
        private async void BtnInserirItemClicked(object sender, EventArgs e)
        {
            ...
            {
                DisplayAlert("Dados incompletos", "Informe um cliente e um item de cardápio", "Ok");
            }
            else
            {
                if (pedido == null)
