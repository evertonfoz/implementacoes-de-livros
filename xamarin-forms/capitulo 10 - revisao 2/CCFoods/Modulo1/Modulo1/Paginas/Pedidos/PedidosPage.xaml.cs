...
namespace Modulo1.Paginas.Pedidos
{
    ...
    public partial class PedidosPage : ContentPage
    {
        ...
        // Captura do Context Action para encaminhar pedido para PRODUÇÃO
        ...
        // Captura do Context Action para encaminhar pedido para ENTREGA
        ...
        // Captura do Context Action para FECHAR Pedido
        ...
        // Método que captura o clique da context action para verificação de rota
        // de entrega
        private async void OnVerificarRotaClick(object o, EventArgs e)
        {
            var mi = ((MenuItem)o);
            var pedido = mi.CommandParameter as Pedido;
